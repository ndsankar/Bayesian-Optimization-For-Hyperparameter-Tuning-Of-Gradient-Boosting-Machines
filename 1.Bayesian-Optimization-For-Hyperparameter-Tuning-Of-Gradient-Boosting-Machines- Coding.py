...
# 3. Baseline model with default parameters
print("\n3. Training baseline model with default parameters...")
...
# Train final model with Random Search best parameters
...
# Train final model with BO best parameters
...
# 7. Convergence Plot
print("\n7. Generating convergence plots...")

# Calculate best scores over time for Random Search
...
# Calculate best scores over time for Bayesian Optimization
...
# 9. Best hyperparameters comparison
print("\n9. Best Hyperparameters Comparison")
print("=" * 50)
